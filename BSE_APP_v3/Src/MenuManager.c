...
void Generate_Menu_Content(void){
	...
	//-- Customer Menu --
	/// level 0
	Telium_Sprintf(var_MnuCustomer,       "INSERT INTO AppMenus (MenuId, MenuName, MenuIdParent, Hidden, SecureMenu, SecureMenuLevel, DrCr, IconPathName) VALUES ('%d', 'Transaction>        ', '0', '0','0' ,'1', ' ', 'file://flash/HOST/TU.TAR/icones/COL_BSEAPP.PNG');",       mnuCustomer);             // CUSTOMER>
	/// level 1
